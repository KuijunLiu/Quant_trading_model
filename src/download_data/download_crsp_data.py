...
Usage:
    python download_crsp_data.py --start_date 1994-01-01
...
def fetch_crsp_data():
    ...
    SELECT
        ...
        a.prc,
        a.shrout,
        -- Delisting return / code are not available in this CRSP library
        -- a.dlret,
        -- a.dlstcd,
        a.cfacpr,
        a.cfacshr,
    ...
    df['mkt_cap'] = df['prc'] * df['shrout'] # compute market cap
